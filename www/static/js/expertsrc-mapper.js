$(function() {
        ...
        $(this).click( function () {
            ...
            $container            // This attribute's row (tr)
                ...
                .find('.status')    // The attributes status cell
                    .text('mapped')
                .end();
            reset_and_display_conf_btns($container.next(), $container.find('.new-mapping'));
        });
    });
    ...
    $(reject_buttons).each(function () {
        ...
        $this.click( function () {
            ...
            reset_and_display_conf_btns($container.next(), $choice);
    ...
    $('.toggle-data-panel').each(function(){
        $(this).click(function(){
            toggle_panel();
        });
    });
    ...
    $saveButton.click(function () {
        ...
        var msg = "After you save your answers, you cannot alter them. " +
                  "Are you sure?";
    ...
    function reset_and_display_conf_btns($container, $choice) {
        // $container = the tr containing the confidence radio buttons
